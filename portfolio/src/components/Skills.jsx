...
const Skills = () => {
  ...
  return (
    <div className='w-full h-screen text-white p-[4rem] '>
       ...
       <h1 className='text-4xl text-[#FABC3F]'>My Skills</h1>
       <span className='w-2/5 h-[0.5px] mt-2 bg-gray-400'></span>

       <div>
          <h1 className='text-xl'>Front end technologies</h1>
         
         <div className='grid grid-cols-6 items-center gap-4 mt-4 '>
         {skills.map((value) => (
            <div key={value.id} className='flex mt-4 '>
                <p className='text-xl flex items-center gap-4 text-gray-400'><div className="arrow2"></div>{value.name}</p>
            </div>
         ))}
       ...
       <div className='mt-4'>
          <h1 className='text-xl'>Back end technologies</h1>

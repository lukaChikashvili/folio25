...
const Home = () => {
  return (
    <div className='text-white w-full h-screen bg-transparent absolute top-0 left-0 p-[4rem]'>
       <div className='pt-[5rem] flex flex-col gap-4' >
          ...
          <p className='text-lg mt-4 w-1/2 text-gray-300'>
          ...
          <button className='bg-[#FABC3F] w-[15rem] mt-4 rounded-md px-12 py-2 shadow-lg neon-button'>Resume</button>
       </div>
    </div>
  )
}

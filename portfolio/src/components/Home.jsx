  ...
  return (
    <div className='text-white w-full h-screen bg-transparent absolute top-0 left-0 p-[4rem]'>
       <div className='pt-[6rem] flex flex-col gap-4' >
          ...
          <h1 className='text-[3rem] md:text-[4rem] lg:text-[4rem] '>Luka Chikashvili</h1>
          <p className='text-3xl md:text-3xl lg:text-4xl'><span className='text-[#FABC3F]'>Full stack</span> web developer</p>
          <span className='w-2/5 h-[0.5px] mt-2 bg-gray-400'></span>
          <p className='text-lg mt-4 md:w-[38rem]  text-gray-300 leading-[2.3rem]'>

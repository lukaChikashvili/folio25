...
const Footer = () => {
  ...
  return (
    <section id = 'footer' className="w-full flex items-center justify-start gap-12  text-white p-4 md:p-[3rem] bg-transparent border-t-2 border-gray-700 mt-[210rem]">
